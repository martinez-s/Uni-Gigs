    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            echo json_encode([
                ...
                'redirect' => 'index.php' // Redirige a la página principal
            ]);
        } else {
...
<body>
    ...
    <div class="cont-crear ">
        <div class="div" style="padding-top: 100px;">
            <h3 class="Titulo titu_crear">CREAR UN SERVICIO</h3>
        </div>
        ...
        <form id="formServicio">
            <div class="row">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <button type="submit" style="width: 100%;" class=" btn_siguiente">CREAR SERVICIO</button>
                </div>
            </div>
        </form>
    </div>
