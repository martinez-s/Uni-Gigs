document.addEventListener('DOMContentLoaded', function() {
        const inputImagen = document.getElementById('input-imagen-servicio');
        ...
        btnTrigger.addEventListener('click', () => inputImagen.click());
        ...
        function mostrarPrevisualizacion() {
            ...
            if (!imagenSeleccionada) {
                ...
                btnTrigger.innerHTML = `<i class="bi bi-image-fill"></i> Seleccionar Imagen (Solo 1)`;
                return;
            }
            ...
            imagenBox.className = 'preview-box-image';
